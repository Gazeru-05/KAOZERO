const characters = ['アミール','オーウェン','オルレア','カイロン','カシウス','カリーペ','セレーナ','トレサ','ニア','ハル','ヒューゴ','ベリル','ベロニカ','マグナ','マリベル','ミカ','メイリン','ユキ','リン','ルーカス','ルーク','レイ','レノア','チズル','セレニエル'];
let currentCharacter = 'セレニエル';
